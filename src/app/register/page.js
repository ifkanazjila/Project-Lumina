...
export default function Register() {
    ...
    const slides = [
        ...
        { image: "/note.png", title: "Welcome to Lumina", desc: "Organize your tasks easily." },
                ...
                <form className="flex flex-col gap-6">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative">
                            <select
                                defaultValue=""
                                className="w-full border border-gray-300 rounded-lg px-4 py-3.5 appearance-none focus:outline-none focus:ring-2 focus:ring-[#213B7F] transition-all text-gray-500 bg-transparent cursor-pointer"
                            >
